...
function Sidebar() {
  ...
  const logout = async () => {
    setLoading(true);
    try {
      // Optionally, you could call an API to invalidate tokens on the backend
      // Example (assuming you have an API route for logout):
      // await axios.post('http://api.your-backend.com/auth/logout');

      // Simulate an async operation (e.g., API call delay)
